...
struct pa_sink_port_info
{
     ...
     *
     * \since 14.0 */
    uint type; /**< Port type, see #pa_device_port_type. \since 14.0 */
}
...
{
    uint index; /**< Index of the module */
    const(char)* name; /**< Name of the module */
    const(char)* argument; /**< Argument string of the module */
    uint n_used; /**< Usage counter or PA_INVALID_INDEX */
    /** \cond fulldocs */
...
{
    uint index; /**< Index of this client */
    const(char)* name; /**< Name of this client */
    uint owner_module; /**< Index of the owning module, or PA_INVALID_INDEX. */
    const(char)* driver; /**< Driver name */
    pa_proplist* proplist; /**< Property list \since 0.9.11 */
}
...
struct pa_card_profile_info
{
    ...
    uint n_sinks; /**< Number of sinks this profile would create */
    uint n_sources; /**< Number of sources this profile would create */
    uint priority; /**< The higher this value is, the more useful this profile is as a default. */
}
...
struct pa_card_port_info
{
    ...
    uint n_profiles; /**< Number of entries in profile array */
    pa_card_profile_info** profiles; /**< \deprecated Superseded by profiles2 */
    pa_proplist* proplist; /**< Property list */
    long latency_offset; /**< Latency offset of the port that gets added to the sink/source latency when the port is active. \since 3.0 */
...
struct pa_card_info
{
    ...
    pa_proplist* proplist; /**< Property list */
    uint n_ports; /**< Number of entries in port array */
...
struct pa_stat_info
{
    uint memblock_total; /**< Currently allocated memory blocks */
    uint memblock_total_size; /**< Current total size of allocated memory blocks */
    uint memblock_allocated; /**< Allocated memory blocks during the whole lifetime of the daemon. */
    uint memblock_allocated_size; /**< Total size of all memory blocks allocated during the whole lifetime of the daemon. */
    uint scache_size; /**< Total size of all sample cache entries. */
}
...
{
    uint index; /**< Index of this entry */
    ...
    uint bytes; /**< Length of this sample in bytes. */
    int lazy_; /**< Non-zero when this is a lazy cache entry. */
...
{
    uint index; /**< Index of this autoload entry */
    const(char)* name; /**< Name of the sink or source */
    pa_autoload_type_t type; /**< Type of the autoload entry */
    const(char)* module_; /**< Module name to load */
