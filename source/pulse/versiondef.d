...
it. */
extern (D) string pa_get_headers_version()
{
    return "15.0.0";
}
...
extern (D) auto PA_CHECK_VERSION(T0, T1, T2)(auto ref T0 major, auto ref T1 minor, auto ref T2 micro)
{
    return (PA_MAJOR > major) || (PA_MAJOR == major && PA_MINOR > minor) || (PA_MAJOR == major && PA_MINOR == minor && PA_MICRO >= micro);
}
