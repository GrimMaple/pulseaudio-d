...
enum PA_PROP_FILTER_WANT = "filter.want";
...
enum PA_PROP_FILTER_APPLY = "filter.apply";
...
enum PA_PROP_EVENT_ID = "event.id";
...
enum PA_PROP_EVENT_DESCRIPTION = "event.description";
...
enum PA_PROP_EVENT_MOUSE_X = "event.mouse.x";
...
enum PA_PROP_EVENT_MOUSE_Y = "event.mouse.y";
...
enum PA_PROP_EVENT_MOUSE_HPOS = "event.mouse.hpos";
...
enum PA_PROP_EVENT_MOUSE_VPOS = "event.mouse.vpos";
...
enum PA_PROP_WINDOW_NAME = "window.name";
...
enum PA_PROP_WINDOW_X = "window.x";
...
enum PA_PROP_WINDOW_Y = "window.y";
...
enum PA_PROP_WINDOW_HEIGHT = "window.height";
...
enum PA_PROP_WINDOW_DESKTOP = "window.desktop";

/** For streams that belong to an X11 window on the screen: the X11 display string. E.g. ":0.0" */
enum PA_PROP_WINDOW_X11_DISPLAY = "window.x11.display";
...
enum PA_PROP_WINDOW_X11_SCREEN = "window.x11.screen";
...
enum PA_PROP_BLUETOOTH_CODEC = "bluetooth.codec";
...
/** \cond fulldocs */
enum PA_UPDATE_SET = pa_update_mode_t.PA_UPDATE_SET;
enum PA_UPDATE_MERGE = pa_update_mode_t.PA_UPDATE_MERGE;
enum PA_UPDATE_REPLACE = pa_update_mode_t.PA_UPDATE_REPLACE;
/** \endcond */
