...
enum PA_VOLUME_NORM = cast(pa_volume_t) 0x10000U;

/** Muted (minimal valid) volume (0%, -inf dB) */
enum PA_VOLUME_MUTED = cast(pa_volume_t) 0U;

/** Maximum valid volume we can store. \since 0.9.15 */
enum PA_VOLUME_MAX = cast(pa_volume_t) UINT32_MAX / 2;
...
extern (D) auto pa_cvolume_reset(T0, T1)(auto ref T0 a, auto ref T1 n)
{
    return pa_cvolume_set(a, n, PA_VOLUME_NORM);
}

/** Set the volume of the first n channels to PA_VOLUME_MUTED */
extern (D) auto pa_cvolume_mute(T0, T1)(auto ref T0 a, auto ref T1 n)
{
...
enum PA_DECIBEL_MININFTY = cast(double) -200.0;
